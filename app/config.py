...
R1_2_CONFIG = {
  ...
  "default_routing_table": {"default": {"netmask": "0xF0", "gateway": R1_1_CONFIG["interface_ip_address"], "hop": 1, "port": R1_1_CONFIG["interface_port"]}},
}
...
R1_3_CONFIG = {
  ...
  "default_routing_table": {"default": {"netmask": "0xF0", "gateway": R1_2_CONFIG["interface_ip_address"], "hop": 1, "port": R1_2_CONFIG["interface_port"]}},
}
