...
pattern = {
    ...
    "dhcp_offer": r'^DHCP Server Offer\|(null|(0x[a-fA-F0-9]{2}))\|(null|(0x[a-fA-F0-9]{2}))$',
    "dhcp_discover": r'^DHCP Client Discover$',
    "dhcp_request": r'^DHCP Client Request\|(0x[a-fA-F0-9]{2})$',
    "dhcp_acknowledgement": r'^DHCP Server Acknowledgement\|(null|(0x[a-fA-F0-9]{2}))\|(null|(0x[a-fA-F0-9]{2}))$',
