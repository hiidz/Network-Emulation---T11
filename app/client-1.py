...
def handle_arp_request(arp_request, conn):
    ...
    is_intended_receiver, ip_looked_for, sender_ip, sender_mac = arp_protocol.verfiy_arp_request_destination(arp_request, client1_ip)
    if is_intended_receiver:
        print("ARP Request is meant for me")
        #Reply the client who sent the ARP Request
        arp_response = f'ARP Response|{ip_looked_for} is at {client1_mac}'
    ...
    while True:
        ...
        if payload.split('|')[0] == 'request_interface_connection':
            ...
            while not arp_protocol.lookup_arp_table(route_ip) and arp_request_attempt <= max_arp_retries:
                ...
                arp_protocol.arp_broadcast(route_ip, client1_mac, client1_ip, conn_list)
            ...
            if arp_protocol.lookup_arp_table(route_ip):
                ...
                ethernet_frame.create(client1_mac, dest_mac, ip_datagram)
